...
---
# Informações do Grupo e Instruções de Execução

## Integrantes do Grupo
- Nome: [Preencher Nome] - Matrícula: [Preencher Matrícula]
- Nome: [Preencher Nome] - Matrícula: [Preencher Matrícula]
- Nome: [Preencher Nome] - Matrícula: [Preencher Matrícula]

## Linguagem Utilizada
- **Java** (Compatível com Java 8 / 1.8 e superior)

## Framework de Testes Unitários
- **JUnit Jupiter** (Versão 5.10.0)
- **JUnit Platform Suite** (Versão 1.10.0)

## Instruções de Execução dos Testes

Os testes deste projeto foram desenvolvidos usando o framework **JUnit 5 (Jupiter)**. Como se trata de um projeto Java Puro (sem Maven/Gradle), a execução dos testes deve ser feita por meio de uma IDE (Ambiente de Desenvolvimento Integrado) que ofereça suporte nativo ou extensões para JUnit 5 (como IntelliJ IDEA, Eclipse ou VS Code).

### Passos para execução na IDE:
1. Abra o diretório raiz deste repositório na sua IDE de escolha.
2. Certifique-se de que a pasta `src` esteja configurada como o diretório de arquivos fonte (*Source Root*).
3. Navegue até o arquivo `src/tppe/deduplication/Case3Test.java` ou `src/tppe/deduplication/Case3Suite.java`.
4. Clique com o botão direito no arquivo de teste ou na classe e selecione a opção **Run** (ou **Run 'Case3Test'** / **Run 'Case3Suite'**).
5. A IDE resolverá automaticamente as dependências de JUnit 5 necessárias e exibirá os resultados em sua interface de testes. 