...
class Case2Deduplicator {

    private final List<AuthorRecord> records;
    private final String[] unifiedNames;
    private final List<List<Integer>> clusters;

    Case2Deduplicator(List<AuthorRecord> records) {
        this.records = records;
        this.unifiedNames = new String[records.size()];
        this.clusters = new ArrayList<>();
    }

    List<AuthorRecord> compute() {
        buildClusters();
        computeUnifiedNames();
        return buildOutput();
    }
    ...
    private void computeUnifiedNames() {
        for (List<Integer> cluster : clusters) {
    ...
    private List<AuthorRecord> buildOutput() {
